...
func GenerateInlinedSpec(t *template.Template, importMapping generator.ImportMap, swagger *openapi3.T) (string, error) {
	return generator.GenerateInlinedSpec(t, importMapping, swagger)
}
